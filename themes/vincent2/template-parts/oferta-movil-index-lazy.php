...
<a href="<?php the_permalink(); ?>" class="oferta-index-single-row" style="background-image:url('<?php echo get_template_directory_uri() ?>/image/taxonomy/tipo-kit/<?php echo $tax_term[0]->slug; ?>/kit-bg-mov.jpg');">
	...
	<div class="oferta-index-category-kit-img">
		<div class="center-img">
			<img class="img-fluid lazy" src="<?php echo get_template_directory_uri() ?>/image/snippets/empty.png" data-src="<?php echo get_template_directory_uri() ?>/image/taxonomy/tipo-kit/<?php echo $tax_term[0]->slug; ?>/kit-group-image.m.png">
		</div>
	...
	<div class="oferta-index-description-container">
		...
		<div class="oferta-index-bullets">
			...
			<div class="bullet">
				<div class="bullet-image">
					<img class="img-fluid" data-src="<?php echo get_template_directory_uri() ?>/image/snippets/check.svg">
				</div>
