...
function multiplus_feats_shortcode($atts = [], $content = null, $tag = '') { 
$message = '
  <div class="text-with-image">
    ...
    <div class="img-part">
      <img src="'.get_template_directory_uri().'/image/snippets/mundooffgrid/powerassist.png">
    </div>
  </div>
  <div class="text-with-image">
    ...
    <div class="img-part flip">
      <img src="'.get_template_directory_uri().'/image/snippets/mundooffgrid/powerline.png">
    </div>
  </div>
  <div class="text-with-image">
    <div class="text-part">
    ...
    <div class="img-part">
      <img src="'.get_template_directory_uri().'/image/snippets/mundooffgrid/6multiplus.png">
    </div>
  </div>  
  <div class="text-with-image">
    <div class="text-part flip">
    ...
    <div class="img-part flip">
      <img src="'.get_template_directory_uri().'/image/snippets/mundooffgrid/pc.png">
    </div>
  </div>
';
return $message;
} 
add_shortcode('multiplus_feats', 'multiplus_feats_shortcode'); 
